...
namespace MSD.Loop.Repository.Data
{
    public class CompanyRepository : BaseRepository, ICompanyRepository
    {
        ...
        public Company Create(Company entity)
        {
            ...
            var query = @"INSERT INTO Companies(Name, CreatedOn, LastModifiedOn, IsArchived, CreatedByUserId, IsDefault) VALUES
                        (@Name, @CreatedOn, @LastModifiedOn, @IsArchived, @CreatedByUserId, @IsDefault); SELECT CAST(SCOPE_IDENTITY() as int)";
