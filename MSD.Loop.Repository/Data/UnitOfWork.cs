...
namespace MSD.Loop.Repository.Data
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private readonly ICompanyAccessRoleRepository _companyAccessRoleRepo;
        ...
        public ICompanyAccessRoleRepository CompanyAccessRoleRepository
        {
            get { return _companyAccessRoleRepo ?? (new CompanyAccessRoleRepository(_transaction)); }
        }
